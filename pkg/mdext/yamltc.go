...
// parser.Context.
//
// WARNING: Hacked to use ++ instead of -- as delimiter
// for the YAML front matter. See lines under comments marked "TC:"
// This is so that TOML can later use -- as delimiters
//
package mdext
